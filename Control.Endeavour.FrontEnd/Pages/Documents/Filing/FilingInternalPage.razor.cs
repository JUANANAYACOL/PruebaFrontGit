...
{
    public partial class FilingInternalPage
    {
        #region Variables
        ...
        private string titleView { get; set; } = "Comunicaciones - Radicación de comunicación interna";
        ...
        private readonly int defaultConfiguration = 5;
        ...
        {
            DocTypologySearchModal.UpdateModalStatus(true, "CL,I");
        }
